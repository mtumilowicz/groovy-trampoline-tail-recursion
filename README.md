[![Build Status](https://travis-ci.com/mtumilowicz/groovy-trampoline-tail-recursion.svg?branch=master)](https://travis-ci.com/mtumilowicz/groovy-trampoline-tail-recursion)
